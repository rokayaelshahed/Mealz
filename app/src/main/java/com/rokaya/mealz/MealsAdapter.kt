...
import com.rokaya.domain.entity.Category
import com.rokaya.mealz.databinding.CategoryItemBinding


class MealsAdapter() : ListAdapter<Category, MealsAdapter.ViewHolder>(CategoryDiffCallback()) {


//    class ViewHolder(private val itemBinding: ActivityMainBinding) : RecyclerView.ViewHolder(itemBinding.root) {
//        fun bind(category: Category) {
////            itemBinding.categoryNameTv.text = category.strCategory
////            itemBinding.categoryDesTv.text = category.strCategoryDescription
//            itemBinding.categoryRv.
